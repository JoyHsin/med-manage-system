...
public class NurseWorkstationIntegrationTest {
    ...
    void testNurseWorkstationWorkflow() throws Exception {
        // 测试方法已注释掉
    }
    ...
    @Order(2)
    @WithMockUser(username = "nurse001", roles = {"NURSE"})
    void testPatientTriageAndVitalSigns() throws Exception {
        // 测试方法已注释掉
    }
    ...
    @Order(3)
    @WithMockUser(username = "nurse001", roles = {"NURSE"})
    void testNurseWorkstationAlerts() throws Exception {
        // 测试方法已注释掉
    }
}
*/